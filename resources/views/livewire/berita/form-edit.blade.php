    ...
    <div x-show="isOpen" x-transition:enter="transition ease-out duration-300"
        ...
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="flex justify-between items-center bg-gray-100 p-4 rounded-t-lg border-b border-gray-200">
                ...
                <button @click="isOpen=false" wire:click="clear({{ $id_berita }})"
            ...
            <div class="p-6">
                <form wire:submit="update" class="space-y-4">
                    <input type="hidden" wire:model="id_berita">
                    <div>
                    ...
                    <div>
                        ...
                        <textarea id="description" wire:model="description" name="description" rows="8"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
