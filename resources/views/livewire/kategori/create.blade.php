<div x-data="{ isOpen: false }" @modal-closed.window="isOpen = false">
    ...
    <button @click="isOpen=true"
        class="bg-green-600 hover:bg-green-700 mb-4 text-white font-bold py-2 px-4 rounded-md shadow-md transition duration-300 ease-in-out transform hover:scale-105">
        Create
    </button>
            ...
            <div class="p-6">
                <form wire:submit="save" class="space-y-4">
                    <div>
                        ...
                        <a href="https://convertio.co/" target="_blank" class="text-sm text-green-500 hover:underline">Ubah Gambar menjadi SVG</a>
