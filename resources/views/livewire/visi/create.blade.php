    ...
    <div x-show="isOpen" x-transition:enter="transition ease-out duration-300"
        ...
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="flex justify-between items-center bg-gray-100 p-4 rounded-t-lg border-b border-gray-200">
                <h3 class="text-xl font-semibold text-gray-800">Tambah Visi</h3>
            ...
            <div class="p-6">
                <form wire:submit="save" class="space-y-4">
                    <div>
                        ...
                        <textarea type="text" id="visi" wire:model="visi" name="visi" rows="8"
                            ...
                            placeholder="Enter vision details"></textarea>
                        @error('visi')
